...
> 版本 v1 · 2026-07-25 · 配套 [开发规范](./开发规范.md) · [踩坑记录](./踩坑记录.md) · [检索eval报告](./检索eval报告.md)
...
详见 [`docs/检索eval报告.md`](./检索eval报告.md)。重跑:`venv/Scripts/python.exe scripts/eval_retrieval.py`
...
- [开发规范](./开发规范.md) — 测试规范 §5(金字塔/命名/FakeEmbedder)
- [踩坑记录](./踩坑记录.md) — 23 条非平凡问题
- [检索eval报告](./检索eval报告.md) — 检索质量量化
- [配置.md](./配置.md) — 技术栈/依赖/运行步骤
